pipeline {
    ...
    environment {
        PROJECT_NAME = "nessaging-RestAPI"
        NEW_JAR_NAME = "nessaging-RestAPI-${BUILD_NUMBER}.jar"
    }
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/SHIVANGI08S/Message-api.git'
            }
        }
        ...
        stage('Copy to C Drive') {
            steps {
                ...
                bat "copy /Y target\\${NEW_JAR_NAME} C:\\Shivangi\\"
            }
        }
    }
